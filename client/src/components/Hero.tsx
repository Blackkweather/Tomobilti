            ...
            <div className="grid grid-cols-2 gap-6 max-w-lg mx-auto mb-8">
              ...
              <a href="/add-car">
                <div className="text-center cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-xl rounded-full w-16 h-16 mx-auto bg-gradient-to-br from-green-500/20 to-green-600/20 border border-white/20 backdrop-blur-sm relative group flex items-center justify-center">
                  {/* Icon - Always visible */}
                  <div className="bg-gradient-to-br from-green-500 to-green-600 text-white p-2 rounded-full shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <DollarSign className="h-6 w-6" />
                  </div>
                  
                  {/* Text - Only visible on hover */}
                  <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/80 text-white p-4 rounded-lg shadow-xl min-w-max z-10">
                    <div className="text-white font-bold text-sm leading-tight mb-1">
                      Insurance Paid Off?
                    </div>
                    <div className="text-white/90 text-xs leading-relaxed text-center">
              ...
              <a href="/become-member">
                <div className="text-center cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-xl rounded-full w-16 h-16 mx-auto bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-white/20 backdrop-blur-sm relative group flex items-center justify-center">
                  {/* Icon - Always visible */}
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-2 rounded-full shadow-lg group-hover:shadow-xl transition-all duration-300">
