...
export default function Services() {
  ...
  const testimonials = [
    {
      ...
      location: "London",
      content: "ShareWheelz has transformed my business travel. The Gold membership saves me hundreds of pounds monthly, and the service is consistently excellent.",
      rating: 5,
    ...
    },
    {
      ...
      role: "Car Owner",
      location: "Manchester",
      content: "I'm earning £400+ monthly from my car that was just sitting in the garage. The platform is easy to use and the support team is fantastic.",
      rating: 5,
    ...
    },
    {
      ...
      location: "Birmingham",
      content: "The variety of cars available and the transparent pricing make ShareWheelz my go-to choice. The insurance coverage gives me complete peace of mind.",
      rating: 5,
  ...
  const trustIndicators = [
    ...
    { icon: Users, text: "50,000+ Members", description: "Trusted by thousands" },
    { icon: Star, text: "4.9/5 Rating", description: "Excellent customer satisfaction" },
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Real stories from satisfied customers across the UK</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust ShareWheelz for their car rental needs across the UK.
          </p>
